...
/**
 * Controller for user interface, functions include album operation, photo operation
 * @author yz745
 * @author yl1160
 */
public class userController implements Initializable{
	...
	/**
	 * preload all album and photos of given user
	...
	/**
	 * initial welcome title for user interface
	 * @throws FileNotFoundException file format incorrect
	 */
	...
	/**
	 * display album information in ListView
	 */
	...
	/**
	 * Create new album object, create corresponding folder and .txt file
	 * @param e create button click
	 * @throws IOException fileWriter input error
	 */
	...
	/**
	 * Delete album that indicated in TextFile include album folder
	 * @param e button click
	 * @throws IOException illegal input
	 */
	...
	/**
	 * Open select album, show photo Thumbnails of the album
	...
	/**
	 * display album information include update to the album display ViewList
	 */
	...
	/**
	 * Logout method that back to login window and save changes
	...
	/**
	 * Write album information to given path
	 * @param path .txt file path
	 * @param allAlbumName given album
	 * @throws IOException illegal input
	 */
	...
	/**
	 * delete all content of given file
	 * @param fileName
	 */
	...
	/**
	 * Add caption to selected photo, content is captured from TextField
	 * @param e button click
	 * @throws IOException illegal input
	 */
	...
	/**
	 * Add tag to selected photo, user need to define tag type to single or multiple,tag can not duplicate
	...
	/**
	 * display selected photo information include caption, date, tags and name
	 * @param pf PictureFile pointer
	 */
	...
	/**
	 * delete selected tag from picture object and .txt file
	 * @throws IOException illegal input
	 */
	...
	/**
	 * handle button click on menu bar
	 * @param e button click event
	 * @throws IOException illegal input
	 */
	...
	/**
	 * Search photo with given date range indicated in specific TextFields, display them in a flowPane
	 * @param e button click
	 * @throws IOException illegal input
	 */
	...
	/**
	 * caption two given date return result
	 * @param a first date
	 * @param b second date
	 * @return boolean value that indicate result
	 */
	...
	/**
	 * Search photos with given tags, two modes implemented which are "and" and "or"
	 * @param e button click
	 * @throws IOException illegal input
	 */
			...
			if(currentAlbum == null) {
				...
				for(int i=0; i<currentAlbum.getPhotoCollection().size(); i++) {
					...
					for(int j=0; j<currentPhoto.getTags().size(); j++) {
						...
						//System.out.println("1. current Tag: "+ currentTagType + ","+currentTagValue);
	...
	/**
	 * Check if have duplicated photo in given album
	 * @param album target album
	 * @param pic target picture
	 * @return boolean value that indicate if it's a duplicated photo
	 */
	...
	/**
	 * User can create a new album with the search result
	 * @param e button click
	 * @throws IOException illegal input
	 */
